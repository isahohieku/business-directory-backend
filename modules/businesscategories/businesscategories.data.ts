 ...
 */
const getBusinessCategoriesData = async (id: string): Promise<BusinessCategoriesModel | BusinessCategoriesModel[] | undefined> => {
    if (!id) {
 ...
 */
const addBusinessCategoriesData = async (businessCategories: BusinessCategoriesModel): Promise<BusinessCategoriesModel | undefined> => {
 ...
 */
const updateBusinessCategoriesData = async (data: BusinessCategoriesModel): Promise<BusinessCategoriesModel | undefined> => {
